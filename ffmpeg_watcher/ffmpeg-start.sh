...
-b:a 128k -vbr off -frame_duration 60 -compression_level 8 -application lowdelay -rtsp_transport udp -f rtsp \
rtsp://rtsp-simple-server:8590/$RTSPPATH 2> /tmp/ffmpeg.log
